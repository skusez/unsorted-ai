...
('d7bed82b-3f97-4646-8800-1d1739e8c8f5', 'Project Alpha', '{"description": "This is Project Alpha"}', 'http://localhost:3000/alpha.jpg', 'Active', 1073741824, 0, 0, false, (SELECT id FROM public.subscriptions WHERE tier = 'Basic' LIMIT 1));

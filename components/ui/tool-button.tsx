...
const ToolButton = forwardRef<HTMLButtonElement, ToolButtonProps>(
  (
    { checked, style, children, onClick, disabled = false, ToolTipLabel },
    ref
  ) => {
    return (
      <button
        ...
        className={cn(
          ...
          checked
            ...
            : "hover:bg-muted-foreground/70 dark:hover:bg-muted-foreground/40", // Updated condition for background color
          style
        )}
      >
        {children}
